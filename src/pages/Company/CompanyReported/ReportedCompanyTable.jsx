...
import { getSingleCompany, updateCompany } from '../../../redux/actions/CompanyAction';
import RepotedByModal from './RepotedByModal';
import { useNavigate } from 'react-router-dom';
import { TruncatedTextWithTooltip } from '../../../components/TruncatedTextWithTooltip';

const ReportedCompanyTable = ({
  data,
  loading,
  handleDelete,
  hendleEdit,
  ...
  console.log(selectedReportedId, 'selectedReporterData');
  const navigate = useNavigate();
  const columns = [
   
    {
      headerName: 'Reported Company Name',
    ...
    },
    {
        ...
        cellRenderer: (params) => {
          ...
          const handleProfileClick = async () => {
            console.log('Clicking on Company ID:', id);
            ...
            try {
              console.log('Dispatching getSingleCompany with ID:', id);
          ...
          const handleDisc = async (item) => {
            console.log('View clicked, id:', item);
            // Pass the reported company details specifically
            const reportedCompanyDetails = {
              ...item.reportedUserId,
              reportInfo: {
                reason: item.reason,
                description: item.description,
                createdAt: item.createdAt,
                reporterInfo: item.reporterUserId
              }
            };
            navigate('/companydetail', { state: reportedCompanyDetails });
          };
...
export default ReportedCompanyTable;
