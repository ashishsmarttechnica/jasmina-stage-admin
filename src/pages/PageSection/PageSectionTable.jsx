  ...
  const columns = [
    ...
    },
    {
      ...
      cellRenderer: (params) => {
        ...
        const languageMap = { en: 'English', de: 'German', fr: 'French', ar: 'Arabic' };
        return <span>{languageMap[code] || code || '-'}</span>;
      },
    },
    {
      field: 'description',
      ...
      width: 230,
      cellRenderer: (params) => {
        const html = params?.data?.description || '';
        return (
          <div
...
export default PageSectionTable;
