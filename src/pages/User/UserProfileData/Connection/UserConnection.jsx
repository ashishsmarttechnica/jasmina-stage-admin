...
const UserConnection = ({ userType, id }) => {
  ...
  const columns = [
      ...
      cellRenderer: (params) => (
        <div className=" mt-5 text-gray-800 text-base font-medium">
          <div className="break-words w-full max-w-xs">
            <img
              src={`${serverurl}/${params.data?.details?.profile?.photo}`}
              alt="profile"
              onError={(e) => {
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <div className="">
          <div className=" mt-5 break-words w-full max-w-xs">
            {params.data?.details?.profile?.fullName ||
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <div className="">
          <div className=" mt-5 break-words w-full max-w-xs">
            {params.data?.details?.profile?.userName ||
