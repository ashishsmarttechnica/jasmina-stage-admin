...
import { loginAdmin } from './../../redux/actions/loginAction.js';
...
export function SignIn() {
  ...
  const validateForm = () => {
    ...
    else if (!validateEmail(data.email)) errors.email = 'Email format is invalid.';
  ...
  const handleSignIn = (e) => {
    ...
    // const predefinedPassword = '1111';
  
    // // Check if email is incorrect
    // if (data.email !== predefinedEmail) {
    //   setLoader(false);
    ...
    // if (data.password !== predefinedPassword) {
    //   setLoader(false);
    ...
    // If both email and password are correct, proceed with login
    ...
    <>
      {/* <Breadcrumb pageName="Sign In" /> */}
        ...
        <div className="flex items-center justify-center h-screen dark:bg-black">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-slate-700 ">
                  ...
                  <span className="mt-15 inline-block">
                    ...
                    >
                      ...
                      <path
                        ...
                        fill={`${themeMode == 'dark' ? '#3056D3' : '#F2F2F2'}`}
                        // fill="#F2F2F2"
                      />
                      <path
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="rounded border-[1.5px] border-stroke bg-transparent w-full py-2 px-2 pl-7 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
              </div>
                {errors.email && (
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="rounded border-[1.5px] w-full border-stroke bg-transparent py-2 px-2 pl-7 text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
              </div>
                {errors.password && (
